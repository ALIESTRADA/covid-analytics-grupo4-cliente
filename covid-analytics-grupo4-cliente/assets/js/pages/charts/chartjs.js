...
getEntriesPorFechaData('02-06-2020');
...
getEntriesSumaData('02-06-2020','Angola');
async function getEntriesSumaData(fecha, pais) {
    await getEntriesPorFechaPais(fecha, pais).then(respuesta => {
